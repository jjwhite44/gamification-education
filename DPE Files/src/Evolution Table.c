...
const struct Evolution gEvolutionTable[NUM_SPECIES][EVOS_PER_MON] =
{
	...
	[SPECIES_LICKITUNG] =        {{EVO_LEVEL, 34, SPECIES_LICKILICKY, 0}},
	...
	[SPECIES_TANGELA] =          {{EVO_LEVEL, 24, SPECIES_TANGROWTH, 0}},
	...
	[SPECIES_SEADRA] =           {{EVO_TRADE_ITEM, ITEM_DRAGON_SCALE, SPECIES_KINGDRA, 0},
								  {EVO_ITEM, ITEM_DRAGON_FANG, SPECIES_KINGDRA, 0}},
	...
	[SPECIES_EEVEE] =            {{EVO_FRIENDSHIP_DAY, 0, SPECIES_ESPEON, 0},
								  ...
								  {EVO_ITEM, ITEM_SHINY_STONE, SPECIES_SYLVEON, 0}, //Require high friendship
	...
	[SPECIES_AIPOM] =            {{EVO_LEVEL, 32, SPECIES_AMBIPOM, 0}},
	[SPECIES_SUNKERN] =          {{EVO_ITEM, ITEM_SUN_STONE, SPECIES_SUNFLORA, 0}},
	[SPECIES_YANMA] =            {{EVO_LEVEL, 33, SPECIES_YANMEGA, 0}},
	...
	[SPECIES_PILOSWINE] =        {{EVO_LEVEL, 40, SPECIES_MAMOSWINE, 0}},
	...
	[SPECIES_FEEBAS] =           {/*{EVO_BEAUTY, 0, SPECIES_MILOTIC, 0},*/
								  {EVO_ITEM, ITEM_WATER_STONE, SPECIES_MILOTIC, 0},
	...
	[SPECIES_DUSCLOPS] =         {{EVO_ITEM, ITEM_DUSK_STONE, SPECIES_DUSKNOIR, 0},
	...
	[SPECIES_CLAMPERL] =         {{EVO_ITEM, ITEM_DUSK_STONE, SPECIES_HUNTAIL, 0},
								  {EVO_ITEM, ITEM_SHINY_STONE, SPECIES_GOREBYSS, 0},
	...
	[SPECIES_BONSLY] =           {{EVO_LEVEL, 32, SPECIES_SUDOWOODO, 0}},
	[SPECIES_MIME_JR] =          {{EVO_LEVEL, 32, SPECIES_MR_MIME, 0}},
	...
	[SPECIES_MANTYKE] =          {{EVO_LEVEL, 36, SPECIES_MANTINE, 0}},
	...
	[SPECIES_SWIRLIX] =          {{EVO_ITEM, ITEM_SHINY_STONE, SPECIES_SLURPUFF, 0},
								  {EVO_TRADE_ITEM, ITEM_SHINY_STONE, SPECIES_SLURPUFF, 0}},
	...
	[SPECIES_STEENEE] =          {{EVO_LEVEL, 28, SPECIES_TSAREENA, 0}},
	...
	[SPECIES_POIPOLE] =          {{EVO_LEVEL, 40, SPECIES_NAGANADEL, 0}},
	...
	[SPECIES_CLOBBOPUS] =        {{EVO_LEVEL, 35, SPECIES_GRAPPLOCT, 0}},
	...
	[SPECIES_MIME_JR_G] =        {{EVO_LEVEL, 32, SPECIES_MR_MIME_G, 0}},
    ...
    [SPECIES_DRAGINCH] =        {{EVO_LEVEL, 35, SPECIES_DRYSALIS, 0}},
    [SPECIES_DRYSALIS] =        {{EVO_LEVEL, 55, SPECIES_DRAKEVEER, 0}},
    [SPECIES_SKITROAR] =        {{EVO_LEVEL, 18, SPECIES_SCAMPROWL, 0}},
    [SPECIES_SCAMPROWL] =        {{EVO_LEVEL, 34, SPECIES_STALKRY, 0}},
    [SPECIES_WHISPARK] =        {{EVO_LEVEL, 26, SPECIES_NIMBURN, 0}},
    [SPECIES_NIMBURN] =        {{EVO_ITEM, ITEM_THUNDER_STONE, SPECIES_STRATORCH, 0},
								  {EVO_ITEM, ITEM_FIRE_STONE, SPECIES_STRATORCH, 0}},
    [SPECIES_PHRAGMEEK] =        {{EVO_LEVEL, 16, SPECIES_PHRAGMACHO, 0}},
    [SPECIES_PHRAGMACHO] =        {{EVO_LEVEL, 30, SPECIES_PHRAGMITY, 0}},
    [SPECIES_SEDIMIX] =        {{EVO_LEVEL, 24, SPECIES_SEDIMATRIX, 0}},
    [SPECIES_STICKLIT] =        {{EVO_LEVEL, 18, SPECIES_CHARBRUSH, 0}},

    [SPECIES_CHARBRUSH] =        {{EVO_LEVEL, 32, SPECIES_CANOPLUME, 0}},
    [SPECIES_GRAIVEL] =        {{EVO_LEVEL, 22, SPECIES_BASALTOMB, 0}},
    [SPECIES_MUERTAD] =        {{EVO_LEVEL, 25, SPECIES_MUERTOAD, 0}},
    [SPECIES_OYSTACHE] =        {{EVO_LEVEL, 20, SPECIES_OYSTAK, 0}},
    [SPECIES_OYSTAK] =        {{EVO_LEVEL, 34, SPECIES_STEROYSTER, 0}},
    [SPECIES_ANKOLIK] =        {{EVO_LEVEL, 40, SPECIES_ANKOLASH, 0}},
    [SPECIES_OMENUTIVE] =        {{EVO_LEVEL, 22, SPECIES_OMEDIAN, 0}},
    [SPECIES_OMEDIAN] =        {{EVO_LEVEL, 38, SPECIES_OMENSE, 0}},
    [SPECIES_NECTINY] =        {{EVO_ITEM, ITEM_DUSK_STONE, SPECIES_NECTERROR, 0},
								  {EVO_ITEM, ITEM_SHINY_STONE, SPECIES_NECTWINKLE, 0}},
    [SPECIES_CUBBRISK] =        {{EVO_ITEM, ITEM_THUNDER_STONE, SPECIES_VOLTONYX, 0}},

    [SPECIES_SKELETASH] =        {{EVO_LEVEL, 45, SPECIES_ELDURAUNT, 0}},
    [SPECIES_BOGMA] =        {{EVO_LEVEL, 20, SPECIES_SUMPLANT, 0}},
    [SPECIES_SUMPLANT] =        {{EVO_LEVEL, 40, SPECIES_MANGROOVE, 0}},
    [SPECIES_LARVAUNCH] =        {{EVO_ITEM, ITEM_METAL_COAT, SPECIES_NASANIO, 0}},
    [SPECIES_PLATYPUP] =        {{EVO_LEVEL, 32, SPECIES_NOXIPUS, 0}},
    [SPECIES_ANGOR] =        {{EVO_LEVEL, 30, SPECIES_ANGOLIATH, 0}},
    [SPECIES_LANCELITL] =        {{EVO_LEVEL, 42, SPECIES_LANCELOT, 0}},
    [SPECIES_ROLYCOOLY] =        {{EVO_LEVEL, 18, SPECIES_CARKOOL, 0}},
    [SPECIES_CARKOOL] =        {{EVO_LEVEL, 34, SPECIES_COOLOSSAL, 0}},
    [SPECIES_ERADICUT] =        {{EVO_LEVEL, 36, SPECIES_ERADICLEAV, 0}},

    [SPECIES_PANGITA] =        {{EVO_LEVEL, 23, SPECIES_PANGOLINA, 0}},
    [SPECIES_PANGOLINA] =        {{EVO_LEVEL, 41, SPECIES_PANGONONA, 0}},
    [SPECIES_NARWATT] =        {{EVO_LEVEL, 30, SPECIES_GALVANAR, 0}},
    [SPECIES_ERODENT] =        {{EVO_LEVEL, 24, SPECIES_DEGRADENT, 0}},
    [SPECIES_FENNOE] =        {{EVO_LEVEL, 24, SPECIES_FENNOQUENT, 0}},
    [SPECIES_FENNOQUENT] =        {{EVO_LEVEL, 35, SPECIES_FENNOETIC, 0}},
    [SPECIES_CLAUNCHER_R] =        {{EVO_LEVEL, 37, SPECIES_CLAWITZER_R, 0}},
    [SPECIES_SQUIBBON] =        {{EVO_LEVEL, 35, SPECIES_KRAKROVE, 0}},
    [SPECIES_KRAKROVE] =        {{EVO_LEVEL, 45, SPECIES_LEVIATOR, 0}},
    [SPECIES_QUAVIV] =        {{EVO_LEVEL, 35, SPECIES_QUAVIVITY, 0}},

    [SPECIES_QUAVIVITY] =        {{EVO_LEVEL, 55, SPECIES_QUAVIVUIT, 0}},
    [SPECIES_GRAMITEE] =        {{EVO_LEVEL, 28, SPECIES_MANATONNE, 0}},
    [SPECIES_ORCINOVA] =        {{EVO_LEVEL, 32, SPECIES_ORCINUX, 0}},
    [SPECIES_POTL] =        {{EVO_LEVEL, 22, SPECIES_POLOTL, 0}},
    [SPECIES_POLOTL] =        {{EVO_LEVEL, 38, SPECIES_PROPHOTL, 0}},
    [SPECIES_BOBITE] =        {{EVO_LEVEL, 40, SPECIES_BOBITAN, 0}},
    [SPECIES_BRISTLIT] =        {{EVO_LEVEL, 16, SPECIES_BARBLAZE, 0}},
    [SPECIES_BARBLAZE] =        {{EVO_LEVEL, 36, SPECIES_PORCUPYRE, 0}},
    [SPECIES_DRIPPO] =        {{EVO_LEVEL, 16, SPECIES_HIPPOUND, 0}},
    [SPECIES_HIPPOUND] =        {{EVO_LEVEL, 36, SPECIES_HYDROTAMUS, 0}},

    [SPECIES_CHIXIE] =        {{EVO_LEVEL, 16, SPECIES_PLUMIX, 0}},
    [SPECIES_PLUMIX] =        {{EVO_LEVEL, 36, SPECIES_CRESTELLAR, 0}},
    [SPECIES_RHYHORN_R] =        {{EVO_LEVEL, 42, SPECIES_RHICICLE, 0}},
    [SPECIES_RHICICLE] =        {{EVO_ITEM, ITEM_ICE_STONE, SPECIES_KRYNOSORUS, 0}},
    [SPECIES_PHANTIS] =        {{EVO_LEVEL, 18, SPECIES_DEMANTIS, 0}},
    [SPECIES_DEMANTIS] =        {{EVO_LEVEL, 36, SPECIES_NECRMANTIS, 0}},
    [SPECIES_PRICKEL] =        {{EVO_LEVEL, 26, SPECIES_SPIKAR, 0}},
    [SPECIES_SPIKAR] =        {{EVO_LEVEL, 42, SPECIES_THORNAVE, 0}},
    [SPECIES_GORITE] =        {{EVO_LEVEL, 25, SPECIES_GORRUST, 0}},
    [SPECIES_GORRUST] =        {{EVO_LEVEL, 44, SPECIES_MINERILLA, 0}},

    [SPECIES_KOMODOSE] =        {{EVO_LEVEL, 28, SPECIES_VENOMODO, 0}},
    [SPECIES_VENOMODO] =        {{EVO_LEVEL, 44, SPECIES_KOMOXIDE, 0}},
    [SPECIES_PLASTYKE] =        {{EVO_LEVEL, 24, SPECIES_PLASTERINE, 0}},
    [SPECIES_PLASTERINE] =        {{EVO_LEVEL, 36, SPECIES_PLASTERION, 0}},
    [SPECIES_JOLTIK_R] =        {{EVO_LEVEL, 36, SPECIES_GALVANTULA_R, 0}},
    [SPECIES_CASSIVER] =        {{EVO_LEVEL, 28, SPECIES_CASSOSAUR, 0}},
    [SPECIES_TERMUK] =        {{EVO_LEVEL, 25, SPECIES_TERMOUND, 0}},

...
//Custom Moves
#define MOVE_BLANK1 0x2E7
#define MOVE_BLANK2 0x2E8
#define MOVE_BLANK3 0x2E9
#define MOVE_BLANK4 0x2EA
#define MOVE_BLANK5 0x2EB
#define MOVE_BLANK6 0x2EC
#define MOVE_BLANK7 0x2ED
#define MOVE_BLANK8 0x2EE
#define MOVE_BLANK9 0x2EF
#define MOVE_BLANK10 0x2F0
#define MOVE_BLANK11 0x2F1
#define MOVE_BLANK12 0x2F2
#define MOVE_BLANK13 0x2F3
#define MOVE_BLANK14 0x2F4
#define MOVE_BLANK15 0x2F5
#define MOVE_BLANK16 0x2F6
#define MOVE_BLANK17 0x2F7
#define MOVE_BLANK18 0x2F8
#define MOVE_BLANK19 0x2F9
#define MOVE_BLANK20 0x2FA
#define MOVE_BLANK21 0x2FB
#define MOVE_BLANK22 0x2FC
#define MOVE_BLANK23 0x2FD
#define MOVE_BLANK24 0x2FE

//Legends Arceus Moves
#define MOVE_DIRECLAW (0x2E7 + 24)
#define MOVE_PSYSHIELDBASH (0x2E8 + 24)
#define MOVE_POWERSHIFT (0x2E9 + 24)
#define MOVE_STONEAXE (0x2EA + 24)
#define MOVE_MYSTICALPOWER (0x2EB + 24)
#define MOVE_RAGINGFURY (0x2EC + 24)
#define MOVE_WAVECRASH (0x2ED + 24)
#define MOVE_CHLOROBLAST (0x2EE + 24)
#define MOVE_MOUNTAINGALE (0x2EF + 24)
#define MOVE_VICTORYDANCE (0x2F0 + 24)
#define MOVE_HEADLONGRUSH (0x2F1 + 24)
#define MOVE_BARBBARRAGE (0x2F2 + 24)
#define MOVE_ESPERWING (0x2F3 + 24)
#define MOVE_BITTERMALICE (0x2F4 + 24)
#define MOVE_SHELTER (0x2F5 + 24)
#define MOVE_TRIPLEARROWS (0x2F6 + 24)
#define MOVE_INFERNALPARADE (0x2F7 + 24)
#define MOVE_CEASELESSEDGE (0x2F8 + 24)
#define MOVE_BLEAKWINDSTORM (0x2F9 + 24)
#define MOVE_WILDBOLTSTORM (0x2FA + 24)
#define MOVE_SANDSEARSTORM (0x2FB + 24)
#define MOVE_SPRINGTIDESTORM (0x2FC + 24)
#define MOVE_LUNARBLESSING (0x2FD + 24)
#define MOVE_TAKEHEART (0x2FE + 24)

//Z-Moves
#define MOVE_BREAKNECK_BLITZ_P (0x2FF + 24)
#define MOVE_BREAKNECK_BLITZ_S (0x300 + 24)
#define MOVE_ALL_OUT_PUMMELING_P (0x301 + 24)
#define MOVE_ALL_OUT_PUMMELING_S (0x302 + 24)
#define MOVE_SUPERSONIC_SKYSTRIKE_P (0x303 + 24)
#define MOVE_SUPERSONIC_SKYSTRIKE_S (0x304 + 24)
#define MOVE_ACID_DOWNPOUR_P (0x305 + 24)
#define MOVE_ACID_DOWNPOUR_S (0x306 + 24)
#define MOVE_TECTONIC_RAGE_P (0x307 + 24)
#define MOVE_TECTONIC_RAGE_S (0x308 + 24)
#define MOVE_CONTINENTAL_CRUSH_P (0x309 + 24)
#define MOVE_CONTINENTAL_CRUSH_S (0x30A + 24)
#define MOVE_SAVAGE_SPIN_OUT_P (0x30B + 24)
#define MOVE_SAVAGE_SPIN_OUT_S (0x30C + 24)
#define MOVE_NEVER_ENDING_NIGHTMARE_P (0x30D + 24)
#define MOVE_NEVER_ENDING_NIGHTMARE_S (0x30E + 24)
#define MOVE_CORKSCREW_CRASH_P (0x30F + 24)
#define MOVE_CORKSCREW_CRASH_S (0x310 + 24)
#define MOVE_INFERNO_OVERDRIVE_P (0x311 + 24)
#define MOVE_INFERNO_OVERDRIVE_S (0x312 + 24)
#define MOVE_HYDRO_VORTEX_P (0x313 + 24)
#define MOVE_HYDRO_VORTEX_S (0x314 + 24)
#define MOVE_BLOOM_DOOM_P (0x315 + 24)
#define MOVE_BLOOM_DOOM_S (0x316 + 24)
#define MOVE_GIGAVOLT_HAVOC_P (0x317 + 24)
#define MOVE_GIGAVOLT_HAVOC_S (0x318 + 24)
#define MOVE_SHATTERED_PSYCHE_P (0x319 + 24)
#define MOVE_SHATTERED_PSYCHE_S (0x31A + 24)
#define MOVE_SUBZERO_SLAMMER_P (0x31B + 24)
#define MOVE_SUBZERO_SLAMMER_S (0x31C + 24)
#define MOVE_DEVASTATING_DRAKE_P (0x31D + 24)
#define MOVE_DEVASTATING_DRAKE_S (0x31E + 24)
#define MOVE_BLACK_HOLE_ECLIPSE_P (0x31F + 24)
#define MOVE_BLACK_HOLE_ECLIPSE_S (0x320 + 24)
#define MOVE_TWINKLE_TACKLE_P (0x321 + 24)
#define MOVE_TWINKLE_TACKLE_S (0x322 + 24)

#define MOVE_CATASTROPIKA (0x323 + 24)
#define MOVE_10000000_VOLT_THUNDERBOLT (0x324 + 24)
#define MOVE_STOKED_SPARKSURFER (0x325 + 24) //Paralyze Target
#define MOVE_EXTREME_EVOBOOST (0x326 + 24) //Double Ancient Power
#define MOVE_PULVERIZING_PANCAKE (0x327 + 24)
#define MOVE_GENESIS_SUPERNOVA (0x328 + 24) //Sets up Psychic Terrain
#define MOVE_SINISTER_ARROW_RAID (0x329 + 24)
#define MOVE_MALICIOUS_MOONSAULT (0x32A + 24)
#define MOVE_OCEANIC_OPERETTA (0x32B + 24)
#define MOVE_SPLINTERED_STORMSHARDS (0x32C + 24) //Removes Terrain
#define MOVE_LETS_SNUGGLE_FOREVER (0x32D + 24)
#define MOVE_CLANGOROUS_SOULBLAZE (0x32E + 24) //Ancient Power
#define MOVE_GUARDIAN_OF_ALOLA (0x32F + 24)
#define MOVE_SEARING_SUNRAZE_SMASH (0x330 + 24)
#define MOVE_MENACING_MOONRAZE_MAELSTROM (0x331 + 24)
#define MOVE_LIGHT_THAT_BURNS_THE_SKY (0x332 + 24)
#define MOVE_SOUL_STEALING_7_STAR_STRIKE (0x333 + 24)

#define FIRST_Z_MOVE        MOVE_BREAKNECK_BLITZ_P
#define LAST_Z_MOVE         MOVE_SOUL_STEALING_7_STAR_STRIKE

//Max Moves
#define MOVE_MAX_GUARD (0x334 + 24)
#define MOVE_MAX_STRIKE_P (0x335 + 24)
#define MOVE_MAX_STRIKE_S (0x336 + 24)
#define MOVE_MAX_KNUCKLE_P (0x337 + 24)
#define MOVE_MAX_KNUCKLE_S (0x338 + 24)
#define MOVE_MAX_AIRSTREAM_P (0x339 + 24)
#define MOVE_MAX_AIRSTREAM_S (0x33A + 24)
#define MOVE_MAX_OOZE_P (0x33B + 24)
#define MOVE_MAX_OOZE_S (0x33C + 24)
#define MOVE_MAX_QUAKE_P (0x33D + 24)
#define MOVE_MAX_QUAKE_S (0x33E + 24)
#define MOVE_MAX_ROCKFALL_P (0x33F + 24)
#define MOVE_MAX_ROCKFALL_S (0x340 + 24)
#define MOVE_MAX_FLUTTERBY_P (0x341 + 24)
#define MOVE_MAX_FLUTTERBY_S (0x342 + 24)
#define MOVE_MAX_PHANTASM_P (0x343 + 24)
#define MOVE_MAX_PHANTASM_S (0x344 + 24)
#define MOVE_MAX_STEELSPIKE_P (0x345 + 24)
#define MOVE_MAX_STEELSPIKE_S (0x346 + 24)
#define MOVE_MAX_FLARE_P (0x347 + 24)
#define MOVE_MAX_FLARE_S (0x348 + 24)
#define MOVE_MAX_GEYSER_P (0x349 + 24)
#define MOVE_MAX_GEYSER_S (0x34A + 24)
#define MOVE_MAX_OVERGROWTH_P (0x34B + 24)
#define MOVE_MAX_OVERGROWTH_S (0x34C + 24)
#define MOVE_MAX_LIGHTNING_P (0x34D + 24)
#define MOVE_MAX_LIGHTNING_S (0x34E + 24)
#define MOVE_MAX_MINDSTORM_P (0x34F + 24)
#define MOVE_MAX_MINDSTORM_S (0x350 + 24)
#define MOVE_MAX_HAILSTORM_P (0x351 + 24)
#define MOVE_MAX_HAILSTORM_S (0x352 + 24)
#define MOVE_MAX_WYRMWIND_P (0x353 + 24)
#define MOVE_MAX_WYRMWIND_S (0x354 + 24)
#define MOVE_MAX_DARKNESS_P (0x355 + 24)
#define MOVE_MAX_DARKNESS_S (0x356 + 24)
#define MOVE_MAX_STARFALL_P (0x357 + 24)
#define MOVE_MAX_STARFALL_S (0x358 + 24)
#define MOVE_G_MAX_VINE_LASH_P (0x359 + 24)
#define MOVE_G_MAX_VINE_LASH_S (0x35A + 24)
#define MOVE_G_MAX_WILDFIRE_P (0x35B + 24)
#define MOVE_G_MAX_WILDFIRE_S (0x35C + 24)
#define MOVE_G_MAX_CANNONADE_P (0x35D + 24)
#define MOVE_G_MAX_CANNONADE_S (0x35E + 24)
#define MOVE_G_MAX_BEFUDDLE_P (0x35F + 24)
#define MOVE_G_MAX_BEFUDDLE_S (0x360 + 24)
#define MOVE_G_MAX_VOLT_CRASH_P (0x361 + 24)
#define MOVE_G_MAX_VOLT_CRASH_S (0x362 + 24)
#define MOVE_G_MAX_GOLD_RUSH_P (0x363 + 24)
#define MOVE_G_MAX_GOLD_RUSH_S (0x364 + 24)
#define MOVE_G_MAX_CHI_STRIKE_P (0x365 + 24)
#define MOVE_G_MAX_CHI_STRIKE_S (0x366 + 24)
#define MOVE_G_MAX_TERROR_P (0x367 + 24)
#define MOVE_G_MAX_TERROR_S (0x368 + 24)
#define MOVE_G_MAX_FOAM_BURST_P (0x369 + 24)
#define MOVE_G_MAX_FOAM_BURST_S (0x36A + 24)
#define MOVE_G_MAX_RESONANCE_P (0x36B + 24)
#define MOVE_G_MAX_RESONANCE_S (0x36C + 24)
#define MOVE_G_MAX_CUDDLE_P (0x36D + 24)
#define MOVE_G_MAX_CUDDLE_S (0x36E + 24)
#define MOVE_G_MAX_REPLENISH_P (0x36F + 24)
#define MOVE_G_MAX_REPLENISH_S (0x370 + 24)
#define MOVE_G_MAX_MALODOR_P (0x371 + 24)
#define MOVE_G_MAX_MALODOR_S (0x372 + 24)
#define MOVE_G_MAX_MELTDOWN_P (0x373 + 24)
#define MOVE_G_MAX_MELTDOWN_S (0x374 + 24)
#define MOVE_G_MAX_DRUM_SOLO_P (0x375 + 24)
#define MOVE_G_MAX_DRUM_SOLO_S (0x376 + 24)
#define MOVE_G_MAX_FIREBALL_P (0x377 + 24)
#define MOVE_G_MAX_FIREBALL_S (0x378 + 24)
#define MOVE_G_MAX_HYDROSNIPE_P (0x379 + 24)
#define MOVE_G_MAX_HYDROSNIPE_S (0x37A + 24)
#define MOVE_G_MAX_WIND_RAGE_P (0x37B + 24)
#define MOVE_G_MAX_WIND_RAGE_S (0x37C + 24)
#define MOVE_G_MAX_GRAVITAS_P (0x37D + 24)
#define MOVE_G_MAX_GRAVITAS_S (0x37E + 24)
#define MOVE_G_MAX_STONESURGE_P (0x37F + 24)
#define MOVE_G_MAX_STONESURGE_S (0x380 + 24)
#define MOVE_G_MAX_VOLCALITH_P (0x381 + 24)
#define MOVE_G_MAX_VOLCALITH_S (0x382 + 24)
#define MOVE_G_MAX_TARTNESS_P (0x383 + 24)
#define MOVE_G_MAX_TARTNESS_S (0x384 + 24)
#define MOVE_G_MAX_SWEETNESS_P (0x385 + 24)
#define MOVE_G_MAX_SWEETNESS_S (0x386 + 24)
#define MOVE_G_MAX_SANDBLAST_P (0x387 + 24)
#define MOVE_G_MAX_SANDBLAST_S (0x388 + 24)
#define MOVE_G_MAX_STUN_SHOCK_P (0x389 + 24)
#define MOVE_G_MAX_STUN_SHOCK_S (0x38A + 24)
#define MOVE_G_MAX_CENTIFERNO_P (0x38B + 24)
#define MOVE_G_MAX_CENTIFERNO_S (0x38C + 24)
#define MOVE_G_MAX_SMITE_P (0x38D + 24)
#define MOVE_G_MAX_SMITE_S (0x38E + 24)
#define MOVE_G_MAX_SNOOZE_P (0x38F + 24)
#define MOVE_G_MAX_SNOOZE_S (0x390 + 24)
#define MOVE_G_MAX_FINALE_P (0x391 + 24)
#define MOVE_G_MAX_FINALE_S (0x392 + 24)
#define MOVE_G_MAX_STEELSURGE_P (0x393 + 24)
#define MOVE_G_MAX_STEELSURGE_S (0x394 + 24)
#define MOVE_G_MAX_DEPLETION_P (0x395 + 24)
#define MOVE_G_MAX_DEPLETION_S (0x396 + 24)
#define MOVE_G_MAX_ONE_BLOW_P (0x397 + 24)
#define MOVE_G_MAX_ONE_BLOW_S (0x398 + 24)
#define MOVE_G_MAX_RAPID_FLOW_P (0x399 + 24)
#define MOVE_G_MAX_RAPID_FLOW_S (0x39A + 24)

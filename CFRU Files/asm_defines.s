...
//Custom Moves
.equ MOVE_BLANK1, 0x2E7
.equ MOVE_BLANK2, 0x2E8
.equ MOVE_BLANK3, 0x2E9
.equ MOVE_BLANK4, 0x2EA
.equ MOVE_BLANK5, 0x2EB
.equ MOVE_BLANK6, 0x2EC
.equ MOVE_BLANK7, 0x2ED
.equ MOVE_BLANK8, 0x2EE
.equ MOVE_BLANK9, 0x2EF
.equ MOVE_BLANK10, 0x2F0
.equ MOVE_BLANK11, 0x2F1
.equ MOVE_BLANK12, 0x2F2
.equ MOVE_BLANK13, 0x2F3
.equ MOVE_BLANK14, 0x2F4
.equ MOVE_BLANK15, 0x2F5
.equ MOVE_BLANK16, 0x2F6
.equ MOVE_BLANK17, 0x2F7
.equ MOVE_BLANK18, 0x2F8
.equ MOVE_BLANK19, 0x2F9
.equ MOVE_BLANK20, 0x2FA
.equ MOVE_BLANK21, 0x2FB
.equ MOVE_BLANK22, 0x2FC
.equ MOVE_BLANK23, 0x2FD
.equ MOVE_BLANK24, 0x2FE

//Legends Arceus Moves
.equ MOVE_DIRECLAW, (0x2E7 + 24)
.equ MOVE_PSYSHIELDBASH, (0x2E8 + 24)
.equ MOVE_POWERSHIFT, (0x2E9 + 24)
.equ MOVE_STONEAXE, (0x2EA + 24)
.equ MOVE_MYSTICALPOWER, (0x2EB + 24)
.equ MOVE_RAGINGFURY, (0x2EC + 24)
.equ MOVE_WAVECRASH, (0x2ED + 24)
.equ MOVE_CHLOROBLAST, (0x2EE + 24)
.equ MOVE_MOUNTAINGALE, (0x2EF + 24)
.equ MOVE_VICTORYDANCE, (0x2F0 + 24)
.equ MOVE_HEADLONGRUSH, (0x2F1 + 24)
.equ MOVE_BARBBARRAGE, (0x2F2 + 24)
.equ MOVE_ESPERWING, (0x2F3 + 24)
.equ MOVE_BITTERMALICE, (0x2F4 + 24)
.equ MOVE_SHELTER, (0x2F5 + 24)
.equ MOVE_TRIPLEARROWS, (0x2F6 + 24)
.equ MOVE_INFERNALPARADE, (0x2F7 + 24)
.equ MOVE_CEASELESSEDGE, (0x2F8 + 24)
.equ MOVE_BLEAKWINDSTORM, (0x2F9 + 24)
.equ MOVE_WILDBOLTSTORM, (0x2FA + 24)
.equ MOVE_SANDSEARSTORM, (0x2FB + 24)
.equ MOVE_SPRINGTIDESTORM, (0x2FC + 24)
.equ MOVE_LUNARBLESSING, (0x2FD + 24)
.equ MOVE_TAKEHEART, (0x2FE + 24)

//Z-Moves
.equ MOVE_BREAKNECK_BLITZ_P, (0x2FF + 24)
.equ MOVE_BREAKNECK_BLITZ_S, (0x300 + 24)
.equ MOVE_ALL_OUT_PUMMELING_P, (0x301 + 24)
.equ MOVE_ALL_OUT_PUMMELING_S, (0x302 + 24)
.equ MOVE_SUPERSONIC_SKYSTRIKE_P, (0x303 + 24)
.equ MOVE_SUPERSONIC_SKYSTRIKE_S, (0x304 + 24)
.equ MOVE_ACID_DOWNPOUR_P, (0x305 + 24)
.equ MOVE_ACID_DOWNPOUR_S, (0x306 + 24)
.equ MOVE_TECTONIC_RAGE_P, (0x307 + 24)
.equ MOVE_TECTONIC_RAGE_S, (0x308 + 24)
.equ MOVE_CONTINENTAL_CRUSH_P, (0x309 + 24)
.equ MOVE_CONTINENTAL_CRUSH_S, (0x30A + 24)
.equ MOVE_SAVAGE_SPIN_OUT_P, (0x30B + 24)
.equ MOVE_SAVAGE_SPIN_OUT_S, (0x30C + 24)
.equ MOVE_NEVER_ENDING_NIGHTMARE_P, (0x30D + 24)
.equ MOVE_NEVER_ENDING_NIGHTMARE_S, (0x30E + 24)
.equ MOVE_CORKSCREW_CRASH_P, (0x30F + 24)
.equ MOVE_CORKSCREW_CRASH_S, (0x310 + 24)
.equ MOVE_INFERNO_OVERDRIVE_P, (0x311 + 24)
.equ MOVE_INFERNO_OVERDRIVE_S, (0x312 + 24)
.equ MOVE_HYDRO_VORTEX_P, (0x313 + 24)
.equ MOVE_HYDRO_VORTEX_S, (0x314 + 24)
.equ MOVE_BLOOM_DOOM_P, (0x315 + 24)
.equ MOVE_BLOOM_DOOM_S, (0x316 + 24)
.equ MOVE_GIGAVOLT_HAVOC_P, (0x317 + 24)
.equ MOVE_GIGAVOLT_HAVOC_S, (0x324 + 24)
.equ MOVE_SHATTERED_PSYCHE_P, (0x319 + 24)
.equ MOVE_SHATTERED_PSYCHE_S, (0x31A + 24)
.equ MOVE_SUBZERO_SLAMMER_P, (0x31B + 24)
.equ MOVE_SUBZERO_SLAMMER_S, (0x31C + 24)
.equ MOVE_DEVASTATING_DRAKE_P, (0x31D + 24)
.equ MOVE_DEVASTATING_DRAKE_S, (0x31E + 24)
.equ MOVE_BLACK_HOLE_ECLIPSE_P, (0x31F + 24)
.equ MOVE_BLACK_HOLE_ECLIPSE_S, (0x320 + 24)
.equ MOVE_TWINKLE_TACKLE_P, (0x321 + 24)
.equ MOVE_TWINKLE_TACKLE_S, (0x322 + 24)

.equ MOVE_CATASTROPIKA, (0x323 + 24)
.equ MOVE_10000000_VOLT_THUNDERBOLT, (0x324 + 24)
.equ MOVE_STOKED_SPARKSURFER, (0x325 + 24) //Paralyze Target
.equ MOVE_EXTREME_EVOBOOST, (0x326 + 24) //Double Ancient Power
.equ MOVE_PULVERIZING_PANCAKE, (0x327 + 24)
.equ MOVE_GENESIS_SUPERNOVA, (0x328 + 24) //Sets up Psychic Terrain
.equ MOVE_SINISTER_ARROW_RAID, (0x329 + 24)
.equ MOVE_MALICIOUS_MOONSAULT, (0x32A + 24)
.equ MOVE_OCEANIC_OPERETTA, (0x32B + 24)
.equ MOVE_SPLINTERED_STORMSHARDS, (0x32C + 24) //Removes Terrain
.equ MOVE_LETS_SNUGGLE_FOREVER, (0x32D + 24)
.equ MOVE_CLANGOROUS_SOULBLAZE, (0x32E + 24) //Ancient Power
.equ MOVE_GUARDIAN_OF_ALOLA, (0x32F + 24)
.equ MOVE_SEARING_SUNRAZE_SMASH, (0x330 + 24)
.equ MOVE_MENACING_MOONRAZE_MAELSTROM, (0x331 + 24)
.equ MOVE_LIGHT_THAT_BURNS_THE_SKY, (0x332 + 24)
.equ MOVE_SOUL_STEALING_7_STAR_STRIKE, (0x333 + 24)
...
.equ SPECIES_GRAIVEL, 0x19D
.equ SPECIES_BASALTOMB, 0x19E
.equ SPECIES_BALBOARINA, 0x19F
.equ SPECIES_METROPOLEX, 0x1A0
.equ SPECIES_URBANDON, 0x1A1
.equ SPECIES_MUERTAD, 0x1A2
.equ SPECIES_MUERTOAD, 0x1A3
.equ SPECIES_OYSTACHE, 0x1A4
.equ SPECIES_OYSTAK, 0x1A5
.equ SPECIES_STEROYSTER, 0x1A6
.equ SPECIES_ANKOLIK, 0x1A7
.equ SPECIES_ANKOLASH, 0x1A8
.equ SPECIES_FLEROS, 0x1A9
.equ SPECIES_OMENUTIVE, 0x1AA
.equ SPECIES_OMEDIAN, 0x1AB
.equ SPECIES_OMENSE, 0x1AC
.equ SPECIES_NECTINY, 0x1AD
.equ SPECIES_NECTERROR, 0x1AE
.equ SPECIES_NECTWINKLE, 0x1AF
.equ SPECIES_ALPARKA, 0x1B0
.equ SPECIES_CUBBRISK, 0x1B1
.equ SPECIES_VOLTONYX, 0x1B2
.equ SPECIES_SKELETASH, 0x1B3
.equ SPECIES_ELDURAUNT, 0x1B4
.equ SPECIES_BOGMA, 0x1B5
.equ SPECIES_SUMPLANT, 0x1B6
.equ SPECIES_MANGROOVE, 0x1B7
...
.equ SPECIES_LARVAUNCH, 0x2D0
.equ SPECIES_NASANIO, 0x2D1
.equ SPECIES_PLATYPUP, 0x2D2
.equ SPECIES_NOXIPUS, 0x2D3
.equ SPECIES_ANGOR, 0x2D4
.equ SPECIES_ANGOLIATH, 0x2D5
.equ SPECIES_SQUALDRON, 0x2D6
.equ SPECIES_LANCELITL, 0x2D7
.equ SPECIES_LANCELOT, 0x2D8
.equ SPECIES_ROLYCOOLY, 0x2D9
.equ SPECIES_CARKOOL, 0x2DA
.equ SPECIES_COOLOSSAL, 0x2DB
.equ SPECIES_ERADICUT, 0x2DC
.equ SPECIES_ERADICLEAV, 0x2DD
.equ SPECIES_PANGITA, 0x2DE
.equ SPECIES_PANGOLINA, 0x2DF
.equ SPECIES_BASCULIN_BLUE, 0x2E0
.equ SPECIES_DARMANITANZEN, 0x2E1
.equ SPECIES_PLASTERINE, 0x2E2
.equ SPECIES_PLASTERION, 0x2E3
.equ SPECIES_JOLTIK_R, 0x2E4
.equ SPECIES_GALVANTULA_R, 0x2E5
.equ SPECIES_TIGREUS, 0x2E6
.equ SPECIES_GANAROCH, 0x2E7
...
.equ SPECIES_PHANTIS, 0x348
.equ SPECIES_DEMANTIS, 0x349
.equ SPECIES_NECRMANTIS, 0x34A
.equ SPECIES_PRICKEL, 0x34B
.equ SPECIES_SPIKAR, 0x34C
.equ SPECIES_THORNAVE, 0x34D
.equ SPECIES_GORITE, 0x34E
.equ SPECIES_GORRUST, 0x34F
.equ SPECIES_MINERILLA, 0x350
.equ SPECIES_KOMODOSE, 0x351
.equ SPECIES_VENOMODO, 0x352
.equ SPECIES_KOMOXIDE, 0x353
.equ SPECIES_PLASTYKE, 0x354
...
.equ SPECIES_DRIPPO, 0x35B
.equ SPECIES_HIPPOUND, 0x35C
.equ SPECIES_HYDROTAMUS, 0x35D
.equ SPECIES_CHIXIE, 0x35E
.equ SPECIES_PLUMIX, 0x35F
.equ SPECIES_CRESTELLAR, 0x360
.equ SPECIES_RHYHORN_R, 0x361
.equ SPECIES_RHICICLE, 0x362
.equ SPECIES_KRYNOSORUS, 0x363
.equ SPECIES_DRAGINCH, 0x364
...
.equ SPECIES_DRYSALIS, 0x399
.equ SPECIES_DRAKEVEER, 0x39A
.equ SPECIES_SKITROAR, 0x39B
.equ SPECIES_SCAMPROWL, 0x39C
.equ SPECIES_STALKRY, 0x39D
.equ SPECIES_WHISPARK, 0x39E
.equ SPECIES_NIMBURN, 0x39F
.equ SPECIES_STRATORCH, 0x3A0
.equ SPECIES_PHRAGMEEK, 0x3A1
.equ SPECIES_PHRAGMACHO, 0x3A2
.equ SPECIES_PHRAGMITY, 0x3A3
.equ SPECIES_ALELOPATCH, 0x3A4
.equ SPECIES_SEDIMIX, 0x3A5
.equ SPECIES_SEDIMATRIX, 0x3A6
.equ SPECIES_STICKLIT, 0x3A7
.equ SPECIES_CHARBRUSH, 0x3A8
.equ SPECIES_CANOPLUME, 0x3A9
.equ SPECIES_KRYRAL, 0x3AA
...
.equ SPECIES_CROTONUM, 0x418
.equ SPECIES_NARWATT, 0x419
.equ SPECIES_GALVANAR, 0x41A
.equ SPECIES_ERODENT, 0x41B
.equ SPECIES_DEGRADENT, 0x41C
.equ SPECIES_FENNOE, 0x41D
.equ SPECIES_FENNOQUENT, 0x41E
.equ SPECIES_FENNOETIC, 0x41F
.equ SPECIES_CLAUNCHER_R, 0x420
.equ SPECIES_CLAWITZER_R, 0x421
.equ SPECIES_SQUIBBON, 0x422
.equ SPECIES_KRAKROVE, 0x423
.equ SPECIES_LEVIATOR, 0x424
.equ SPECIES_QUAVIV, 0x425
.equ SPECIES_QUAVIVITY, 0x426
.equ SPECIES_QUAVIVUIT, 0x427
.equ SPECIES_GRAMITEE, 0x428
...
.equ SPECIES_MANATONNE, 0x43D
.equ SPECIES_ORCINOVA, 0x43E
.equ SPECIES_ORCINUX, 0x43F
.equ SPECIES_POTL, 0x440
.equ SPECIES_POLOTL, 0x441
.equ SPECIES_PROPHOTL, 0x442
.equ SPECIES_BOBITE, 0x443
.equ SPECIES_BOBITAN, 0x444

.equ SPECIES_EXTORTLE, 0x445
.equ SPECIES_YAKMAIL, 0x446
.equ SPECIES_BRIBOON, 0x447
.equ SPECIES_CORRAPTOR, 0x448
.equ SPECIES_BRISTLIT, 0x449
.equ SPECIES_BARBLAZE, 0x44A
.equ SPECIES_PORCUPYRE, 0x44B
...
.equ SPECIES_CASSIVER, 0x4AC
.equ SPECIES_CASSOSAUR, 0x4AD
.equ SPECIES_TERMUK, 0x4AE
.equ SPECIES_TERMOUND, 0x4AF
